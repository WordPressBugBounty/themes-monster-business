...
if ( 'posts' != get_option( 'show_on_front' ) ){ 
    get_header(); ?>
    <?php $enabled_sections = monster_business_get_sections();
    if( is_array( $enabled_sections ) ) {
        foreach( $enabled_sections as $section ) {

            if( ( $section['id'] == 'featured-slider' ) ){ ?>
                <?php $disable_featured_slider = monster_business_get_option( 'disable_featured_slider' );
            ...
            <?php } elseif( $section['id'] == 'services' ) { ?>
                <?php $disable_service_section = monster_business_get_option( 'disable_service_section' );
            ...
            <?php } elseif( $section['id'] == 'courses' ) { ?>
                <?php $disable_courses_section = monster_business_get_option( 'disable_courses_section' );
            ...
            <?php } elseif( $section['id'] == 'cta' ) { ?>
                <?php $disable_cta_section = monster_business_get_option( 'disable_cta_section' );
                $background_cta_section = monster_business_get_option( 'background_cta_section' );
            ...
            <?php } elseif( $section['id'] == 'gallery' ) { ?>
                <?php $disable_gallery_section = monster_business_get_option( 'disable_gallery_section' );
            ...
            elseif( ( $section['id'] == 'blog' ) ){ ?>
                <?php $disable_blog_section = monster_business_get_option( 'disable_blog_section' );
