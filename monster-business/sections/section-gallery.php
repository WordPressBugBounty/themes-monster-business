 ...
 */
    $gallery_title       = monster_business_get_option( 'gallery_title' );
    $gy_content_type     = monster_business_get_option( 'gy_content_type' );
    $number_of_gy_column = monster_business_get_option( 'number_of_gy_column' );
    $number_of_gy_items  = monster_business_get_option( 'number_of_gy_items' );
    for( $i=1; $i<=$number_of_gy_items; $i++ ) :
        $gallery_page_posts[] = absint(monster_business_get_option( 'gallery_page_'.$i ) );
    endfor;
    ?>
