...
?>
<?php 
	 $blog_title    = monster_business_get_option( 'blog_title' );
	 $blog_category = monster_business_get_option( 'blog_category' );
	 $blog_number	= monster_business_get_option( 'blog_number' );
		    	...
		    	<div class="post-item">
			      	<?php if(has_post_thumbnail()):?>
				        <div class="featured-image">
				        	<a href="<?php the_permalink();?>"><?php the_post_thumbnail('monster-blog');?></a>  
				        </div>
			    	<?php endif?>
