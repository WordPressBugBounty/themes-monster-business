...
$wp_customize->add_section( 'section_featured_slider',
	array(
		'title'      => __( 'Featured Slider', 'monster-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_featured_slider]', 
	array(		
	'label' 	=> __('Disable Slider Section', 'monster-business'),
...
$wp_customize->add_control('theme_options[number_of_sr_items]', 
	array(
	'label'       => __('Number Of Slides', 'monster-business'),
	'description' => __('Save & Refresh the customizer to see its effect. Maximum is 3.', 'monster-business'),
	'section'     => 'section_featured_slider',   
	'settings'    => 'theme_options[number_of_sr_items]',		
	'type'        => 'number',
	'active_callback' => 'monster_business_slider_active',
	'input_attrs' => array(
			'min'	=> 1,
			'max'	=> 3,
			'step'	=> 1,
...
$wp_customize->add_control('theme_options[sr_content_type]', 
	...
	'active_callback' => 'monster_business_slider_active',
	'choices'	  => array(
			'sr_page'	  => __('Page','monster-business'),
		),
	)
);

$number_of_sr_items = monster_business_get_option( 'number_of_sr_items' );
...
for( $i=1; $i<=$number_of_sr_items; $i++ ){
	...
	$wp_customize->add_control('theme_options[slider_page_'.$i.']', 
		...
		'type'        => 'dropdown-pages',
		'active_callback' => 'monster_business_slider_page',
		)
	);
}
