...
$wp_customize->add_section( 'section_home_blog',
	array(
		'title'      => __( 'Blog Section', 'monster-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_blog_section]', 
	array(		
	'label' 	=> __('Disable Blog Section', 'monster-business'),
...
$wp_customize->add_control('theme_options[blog_title]', 
	...
	'active_callback' => 'monster_business_blog_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control(
	new monster_business_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
		'label'    => __( 'Select Category', 'monster-business' ),
		'section'  => 'section_home_blog',
...
$wp_customize->add_control( 'theme_options[blog_number]',
	array(
		'label'       => __( 'Number of Posts', 'monster-business' ),
		'description' => __('Maximum number of post to show is 6.', 'monster-business'),
		'section'     => 'section_home_blog',
		'active_callback' => 'monster_business_blog_active',		
		'type'        => 'number',
		'priority'    => 100,
