...
$wp_customize->add_section( 'section_home_service',
	array(
		'title'      => __( 'Featured Services', 'monster-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_service_section]', 
	array(		
	'label' 	=> __('Disable Services Section', 'monster-business'),
...
$wp_customize->add_control('theme_options[service_title]', 
	...
	'active_callback' => 'monster_business_services_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control('theme_options[number_of_ss_items]', 
	array(
	'label'       => __('Number Of Services', 'monster-business'),
	'description' => __('Save & Refresh the customizer to see its effect. Maximum is 3.', 'monster-business'),
	'section'     => 'section_home_service',   
...
$wp_customize->add_control('theme_options[ss_content_type]', 
	...
	'active_callback' => 'monster_business_services_active',
	'choices'	  => array(
			'ss_page'	  => __('Page','monster-business'),
		),
	)
);
...
for( $i=1; $i<=$number_of_ss_items; $i++ ){
	...
	$wp_customize->add_control('theme_options[services_page_'.$i.']', 
		...
		'type'        => 'dropdown-pages',
		'active_callback' => 'monster_business_services_page',
		)
	);
}