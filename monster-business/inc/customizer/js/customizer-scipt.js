...
*/
 jQuery(document).ready(function($) {
    $('#monster-img-container li label img').click(function(){    	
        $('#monster-img-container li').each(function(){
            $(this).find('img').removeClass ('monster-radio-img-selected') ;
        });
        $(this).addClass ('monster-radio-img-selected') ;
    });                    
});
